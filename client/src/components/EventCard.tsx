...
const EventCard: React.FC<EventCardProps> = ({ eventName, trainedBy, info, price, image }) => {
  return (
    <div className="relative rounded-s-md shadow-xl p-6 m-3 pt-1 pl-0 pr-0 bg-white">
        ...
        <p className="text-gray-500 text-lg text-left pl-4 font-bold mb-4">
        ...
        <span className="bg-red-500 text-white font-bold flex items-center justify-center w-14 h-14 rounded-full absolute left-64  md:bottom-20 lg:bottom-32">
          {price}
        </span>
    </div>
  );
